...
export function loadConfig() {
  ...
  return {
    ...
    forceBaseBuyWeeklyLimit: numberEnv("FORCE_BASE_BUY_WEEKLY_LIMIT", 0),
    ...
    emailReportTo: process.env.EMAIL_REPORT_TO || "",
    emailReportFrom: process.env.EMAIL_REPORT_FROM || "Crypto Bot <bot@localhost>",
